//! Behaviour tests for `wc-scene`, written before the implementation.
//!
//! `wc-scene` is the host-side model of where app windows live on screen and
...
use wc_scene::{KeyboardTarget, Point, PointerTarget, Portal, Scene, Transform};
