    ...
    fn the_grepped_log_messages_are_what_the_scripts_expect() {
        for (pattern, script, name) in [
            ...
            (
                ...
                // pixels rather than merely on it not being fully opaque — a
                // translucent background behind the element composites to
                // something in between and would otherwise pass — so the
                // number the client draws at is part of the agreement, and
