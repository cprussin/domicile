...
// server; the sequence of those lines is the whole verdict.
...
const schedule = [
  { act: () => navigate("/two"), after: settle },
  { act: () => call("goBack", (v) => v.goBack()), after: step },
  { act: () => call("goForward", (v) => v.goForward()), after: step },
  { act: () => call("reload", (v) => v.reload()), after: step },
